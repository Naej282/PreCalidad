...
public class Cases_475 {
	...
	public void test() throws IOException, InterruptedException {
		...
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 31, 5);
		...
		String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 475";
