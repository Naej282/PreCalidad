...
public class Cases_472 {
	...
	public void test() throws IOException, InterruptedException {
		...
		String TipoUnidad = readFile.getCellValue(filepath, "Cases", 28, 1);
		String Unidad = readFile.getCellValue(filepath, "Cases", 28, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 28, 5);
		...
		// Cambio de Pestaña - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
			...
			String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 472";
