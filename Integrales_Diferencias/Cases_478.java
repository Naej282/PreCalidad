...
public class Cases_478 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante - Cheque mismo Banco - Inventario ----------	
		...
		String TipoUnidad = readFile.getCellValue(filepath, "Cases", 34, 1);
		String Unidad = readFile.getCellValue(filepath, "Cases", 34, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 34, 5);
		...
		String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 478";
