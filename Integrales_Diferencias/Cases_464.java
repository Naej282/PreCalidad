...
public class Cases_464 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante - Abono en Cuenta - AG / CDA ----------	
		...
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 20, 5);
		...
		String directorioCapturas = "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 464";
	    ...
	    String mensajeInformativo = texto;
	    	 writeFile.writeCellValue(filepath, "Cases", 20, 7, mensajeInformativo);	
	    	 	
	        
	    //Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	    	 	
	    String Cataporte =  numeroTexto;
	       	writeFile.writeCellValue(filepath, "Cases", 20, 8, Cataporte);
		...
		String nroServicio = readFile.getCellValue(filepath, "Cases", 20, 8);
		...
		String MensajeInformativoAprobado =  MensajeAprobado;
	    	writeFile.writeCellValue(filepath, "Cases", 20, 9, MensajeInformativoAprobado);
		...
		String MensajeInformativoDespachado =  MensajeDespachado;
			writeFile.writeCellValue(filepath, "Cases", 20, 10, MensajeInformativoDespachado);
	    ...
	    String MensajeInformativoRecibido =  MensajeRecibido;
	    	writeFile.writeCellValue(filepath, "Cases", 20, 11, MensajeInformativoRecibido);
        ...
        String MensajeInformativoSobrante =  MensajeSobrante;
        	writeFile.writeCellValue(filepath, "Cases", 20, 16, MensajeInformativoSobrante);
