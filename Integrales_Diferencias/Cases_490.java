...
public class Cases_490 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante - Cheque de otros Bancos - CDA / AG ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 46, 1);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 46, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 46, 5);
	    ...
	    String mensajeInformativo = Texto;
	    	writeFile.writeCellValue(filepath, "Cases", 46, 7, mensajeInformativo);	
	            	    	    	 	
	            	    	    	
	    //Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -	
	            	    	 	 	
	    String NroObservacion =  Observacion;
	    	writeFile.writeCellValue(filepath, "Cases", 46, 8, NroObservacion);
	    ...
	    String MensajeInformativoAprobado =  MensajeAprobado;
	    	writeFile.writeCellValue(filepath, "Cases", 46, 9, MensajeInformativoAprobado);        	Thread.sleep(secDelay); 
	    ...
	    String Cataporte =  NumeroTexto;
	    	writeFile.writeCellValue(filepath, "Cases", 46, 8, Cataporte);
	                     	    	        	
	    String NroServicio = readFile.getCellValue(filepath, "Cases", 46, 8);
	    ...
	    String MensajeInformativoDespachado =  MensajeDespachado;
	    	writeFile.writeCellValue(filepath, "Cases", 46, 10, MensajeInformativoDespachado);
	    ...
	    String MensajeInformativoRecibido =  MensajeRecibido;
	    	writeFile.writeCellValue(filepath, "Cases", 46, 11, MensajeInformativoRecibido);
	    ...
	    String MensajeInformativoEstadoSobrante =  MensajeSobrante;
	    	writeFile.writeCellValue(filepath, "Cases", 46, 14, MensajeInformativoEstadoSobrante);	Thread.sleep(secDelay); 
