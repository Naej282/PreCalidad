...
public class Cases_494 {
	...
	public void test() throws IOException, InterruptedException {
			...
			//  ----------  Saldar Diferencia Faltante -  Reposicion de Efectivo - Inventario ----------	
			...
			String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 50, 1);
			String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 50, 2);
			String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 50, 5);
			...
			// Cambio de Pestaña - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
		 	...
		 	String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 494";
