...
public class Cases_495 {
	...
	public void test() throws IOException, InterruptedException {
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 51, 1);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 51, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 51, 5);
		...
		String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 495";
