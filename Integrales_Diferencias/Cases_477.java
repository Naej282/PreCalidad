...
public class Cases_477 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante - Entrega de Efectivo - Inventario ----------	
		...
		String TipoUnidad = readFile.getCellValue(filepath, "Cases", 33, 1);
		String Unidad = readFile.getCellValue(filepath, "Cases", 33, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 33, 5);
		...
		// Cambio de Pestaña - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
		 ...
		 String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 477";
		...
		// Ajuste Sobrante - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
			  	 ...
			  	 WebElement AjusteInventario = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ajusteInventario-btnWrap")));
		            ...
		            WebElement SeleccionarClasificaciónAjuste = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[text()='Aptos']")));
		            SeleccionarClasificaciónAjuste.click();
	        ...
	        // Entrega de Efectivo - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
		        ...
		        WebElement ColocarCantidad = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("cantidadEfec-inputEl")));
		        ...
		        WebElement PresionarAceptar = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("aceptarReg-btnInnerEl")));
