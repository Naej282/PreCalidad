...
public class Cases_473 {
	...
	public void test() throws IOException, InterruptedException {
		...
		String TipoUnidad = readFile.getCellValue(filepath, "Cases", 29, 1);
		String Unidad = readFile.getCellValue(filepath, "Cases", 29, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 29, 5);
		...
		String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 473";
