...
public class Cases_464_468 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//----------Saldar Diferencia Sobrante - Abono en Cuenta, Contra Ingreso, Entrega de Efectivo, Cheque mismo Banco, Cheque de otros Bancos- AG / CDA----------	
		
		// Excel - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
								
		String filepath =  "" + Constantes.RUTA_EXCEL + "\\MatrizIntegrales.xlsx";	
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 20, 3);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 20, 4);	
		...
		String directorioCapturas = "" + Constantes.RUTA_CAPTURES + "\\Integrales_Diferencia\\Cases_464_468";
		...
		String outputFile = ""+Constantes.RUTA_CAPTURES+"\\Integrales_Diferencia\\Cases_464_468\\"+nombreArchivo+"";
        ...
        List<WebElement> SeleccionarDenominacionSobrante = driver.findElements(By.xpath("//li[text()='"+Constantes.DENOMINACION_DIFERENCIA+"' or text()='BILLETES - 100,00000000']"));          
        ...
        WebElement SeleccionarClasificacionSobrante = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[text()='"+Constantes.APTOS+"']")));
