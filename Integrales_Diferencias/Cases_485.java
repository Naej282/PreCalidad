...
public class Cases_485 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Faltante - Cheques de otros Bancos - CDA / AG ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 41, 1);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 41, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 41, 5);
		...
		// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	 	...
	 	String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 485";
        ...
        String mensajeInformativo = Texto;
        	writeFile.writeCellValue(filepath, "Cases", 41, 7, mensajeInformativo);	
        	    	    	 	
        	    	    	
        //Mensaje Cataporte Remesa	
        	    	 	 	
        String NroObservacion =  Observacion;
        	writeFile.writeCellValue(filepath, "Cases", 41, 8, NroObservacion);
        ...
        String MensajeInformativoAprobado =  MensajeAprobado;
        	writeFile.writeCellValue(filepath, "Cases", 41, 9, MensajeInformativoAprobado);        	Thread.sleep(secDelay); 
        ...
        String Cataporte =  NumeroTexto;
             writeFile.writeCellValue(filepath, "Cases", 41, 8, Cataporte);
                	    	        	
        String NroServicio = readFile.getCellValue(filepath, "Cases", 41, 8);
        ...
        String MensajeInformativoDespachado =  MensajeDespachado;
        	writeFile.writeCellValue(filepath, "Cases", 41, 10, MensajeInformativoDespachado);
        ...
        String MensajeInformativoRecibido =  MensajeRecibido;
            	writeFile.writeCellValue(filepath, "Cases", 41, 11, MensajeInformativoRecibido);
        ...
        String MensajeInformativoEstadoFaltante =  MensajeFaltante;
        	writeFile.writeCellValue(filepath, "Cases", 41, 14, MensajeInformativoEstadoFaltante);	Thread.sleep(secDelay);
