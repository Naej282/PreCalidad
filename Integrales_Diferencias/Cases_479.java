...
public class Cases_479 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante - Cheque de otros Banco - Inventario ----------	
		...
		String TipoUnidad = readFile.getCellValue(filepath, "Cases", 35, 1);
		String Unidad = readFile.getCellValue(filepath, "Cases", 35, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 35, 5);
		...
		String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 479";
	    ...
	    // Validar Cierre de Unidades - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -      	  
	 	...
	 	WebElement ConsultarCierre_Final = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ext-gen86")));
