...
public class Cases_476 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante - Contra Ingreso - Inventario ----------	
		...
		String TipoUnidad = readFile.getCellValue(filepath, "Cases", 32, 1);
		String Unidad = readFile.getCellValue(filepath, "Cases", 32, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 32, 5);
		...
		String Modalidad ="//li[text()='Contra Ingreso']";
		 ...
		 // Cambio de Pestaña - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
			...
			String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 476";
