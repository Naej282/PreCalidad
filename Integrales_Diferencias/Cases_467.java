...
public class Cases_467 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante - Cheque mismo Banco - AG / CDA ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 23, 3);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 23, 4);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 23, 5);
		...
		String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 467";
	    ...
	    String mensajeInformativo = texto;
	    	writeFile.writeCellValue(filepath, "Cases", 23, 7, mensajeInformativo);	
	    	    	 	
	    	        
	    //Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	    	    	 	
	    String Cataporte =  numeroTexto;
	    	writeFile.writeCellValue(filepath, "Cases", 23, 8, Cataporte);
		...
		String nroServicio = readFile.getCellValue(filepath, "Cases", 23, 8);
		...
		String MensajeInformativoAprobado =  MensajeAprobado;
			writeFile.writeCellValue(filepath, "Cases", 23, 9, MensajeInformativoAprobado);
		...
		String MensajeInformativoDespachado =  MensajeDespachado;
			writeFile.writeCellValue(filepath, "Cases", 23, 10, MensajeInformativoDespachado);
		...
		String MensajeInformativoRecibido =  MensajeRecibido;
			writeFile.writeCellValue(filepath, "Cases", 23, 11, MensajeInformativoRecibido);
		...
		String MensajeInformativoSobrante =  MensajeSobrante;
			writeFile.writeCellValue(filepath, "Cases", 23, 16, MensajeInformativoSobrante);
