...
public class Cases_497_501 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante -  Abono en Cuenta - Inventario ----------			
		// Excel - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
		...
		String outputFile = ""+Constantes.RUTA_CAPTURES+"\\Integrales_Diferencia\\Cases_497_501\\"+nombreArchivo+"";
		...
		String directorioCapturas = "" + Constantes.RUTA_CAPTURES + "\\Integrales_Diferencia\\Cases_497_501";
	    ...
	    List<WebElement> SeleccionarDenominacionSobrante = driver.findElements(By.xpath("//li[text()='Billete - 100,000' or text()='Billete - 100,00000000']"));          
        for (WebElement SeleccionarDenominacionSobrates : SeleccionarDenominacionSobrante ) {
    	SeleccionarDenominacionSobrates.click();     Thread.sleep(secDelay);
        }
		...
		WebElement incluirAjuste = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("button-1087-btnWrap")));
	    ...
	    WebElement ConsultarDiferencia = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("button-1041-btnInnerEl")));
	    ConsultarDiferencia.click();      
	    WebElement SeleccionarDiferencia = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("td[data-columnid='gridcolumn-1025']")));
	 ...
	 // Abono en Cuenta - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -	      
	    ...
	    WebElement PresionarAceptar = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("aceptarSald")));
        ...
        WebElement BovedaDiferenciasSobranteAbonoEnCuenta = driver.findElement(By.id("bovedaEntradaCierre"));
     	...
     	Assert.assertEquals(BovedaDiferenciasDoubleSobranteAbonoEnCuenta, (BovedaDiferenciasSobranteDouble + 500), 0.000001);
	    ...
	    WebElement SeleccionarDiferencia2 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("td[data-columnid='gridcolumn-1025']")));
        ...
        WebElement PresionarAceptar2 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("aceptarSald")));
		...
		String ExpectativaTextoDiferencia2 = "Registro creado exitosamente";
        ...
        WebElement BovedaDiferenciasSobranteContraIngreso = driver.findElement(By.id("bovedaEntradaCierre"));
     	...
     	Assert.assertEquals(BovedaDiferenciasDoubleSobranteContraIngreso, (BovedaDiferenciasSobranteDouble + 500), 0.000001);
	    ...
	    WebElement SeleccionarDiferencia4 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("td[data-columnid='gridcolumn-1025']")));
        ...
        WebElement PresionarAceptar4 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("aceptarSald-btnInnerEl")));
		...
		String ExpectativaTextoDiferencia4 = "Registro creado exitosamente";
        ...
        WebElement BovedaDiferenciasReposicionEfectivoSobrante = driver.findElement(By.id("bovedaEntradaCierre"));
     	...
     	Assert.assertEquals(BovedaDiferenciasDoubleReposicionEfectivoSobrante, (BovedaDiferenciasSobranteDouble + 500), 0.000001);
	    ...
	    WebElement SeleccionarDiferencia5 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("td[data-columnid='gridcolumn-1025']")));
        ...
        WebElement PresionarAceptar5 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("aceptarSald-btnInnerEl")));
		...
		String ExpectativaTextoDiferencia5 = "Registro creado exitosamente";
        ...
        WebElement BovedaDiferenciasSobranteChequeMismosBancos = driver.findElement(By.id("bovedaEntradaCierre"));
     	...
     	Assert.assertEquals(BovedaDiferenciasSobranteDoubleChequeMismosBancos, (BovedaDiferenciasSobranteDouble + 500), 0.000001);
	    ...
	    WebElement SeleccionarDiferencia6 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("td[data-columnid='gridcolumn-1025']")));
        ...
        WebElement PresionarAceptar6 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("aceptarSald-btnInnerEl")));
		...
		String ExpectativaTextoDiferencia6 = "Registro creado exitosamente";
        ...
        WebElement BovedaDiferenciasSobranteChequeOtrosBancos = driver.findElement(By.id("bovedaEntradaCierre"));
     	...
     	Assert.assertEquals(BovedaDiferenciasSobranteDoubleChequeOtrossBancos, (BovedaDiferenciasSobranteDouble + 500), 0.000001);
    	...
    	FileUtils.copyFile(archivo7, new File(captura6));  Thread.sleep(secDelay);	
	}
