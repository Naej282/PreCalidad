...
public class Cases_462 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Faltante - Cheque mismo Banco - AG / CDA ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 18, 3);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 18, 4);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 18, 5);
		...
		String directorioCapturas = "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 462";
	    ...
	    String mensajeInformativo = texto;
	    	 writeFile.writeCellValue(filepath, "Cases", 18, 7, mensajeInformativo);	
	    	 	
	        
	    //Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	    	 	
	    String Cataporte =  numeroTexto;
	       	writeFile.writeCellValue(filepath, "Cases", 18, 8, Cataporte);
	    ...
	    String nroServicio = readFile.getCellValue(filepath, "Cases", 18, 8);
	    ...
	    String MensajeInformativoAprobado =  MensajeAprobado;
	        writeFile.writeCellValue(filepath, "Cases", 18, 9, MensajeInformativoAprobado);
	    ...
	    String MensajeInformativoDespachado =  MensajeDespachado;
	        writeFile.writeCellValue(filepath, "Cases", 18, 10, MensajeInformativoDespachado);
        ...
        String MensajeInformativoRecibido =  MensajeRecibido;
            writeFile.writeCellValue(filepath, "Cases", 18, 11, MensajeInformativoRecibido);
        ...
        String MensajeInformativoFaltante =  MensajeFaltante;
            writeFile.writeCellValue(filepath, "Cases", 18, 14, MensajeInformativoFaltante);
