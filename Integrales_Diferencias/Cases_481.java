...
public class Cases_481 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Faltante - Contra Gasto - CDA / AG ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 37, 1);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 37, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 37, 5);
		...
		// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	 	...
	 	String Modalidad ="//li[text()='Contra Gasto']";
	 	...
	 	String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 481";
        ...
        String mensajeInformativo = Texto;
    	 	writeFile.writeCellValue(filepath, "Cases", 37, 7, mensajeInformativo);	
    	 	
    	
    	//Mensaje Cataporte Remesa	
 	 	
     	String NroObservacion =  Observacion;
        	writeFile.writeCellValue(filepath, "Cases", 37, 8, NroObservacion);
		...
		String CentralEnvios = (String) handles2.toArray()[handles2.size() - 1];
			driver.switchTo().window(CentralEnvios);			Thread.sleep(secDelay);  
	        	      
		WebElement ConsultaEnviosCentral = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("buscarFiltro-btnWrap")));
	    ConsultaEnviosCentral.click();
        ...
        String MensajeInformativoAprobado =  MensajeAprobado;
        	writeFile.writeCellValue(filepath, "Cases", 37, 9, MensajeInformativoAprobado);        	Thread.sleep(secDelay); 
	    ...
	    String Cataporte =  NumeroTexto;
	        writeFile.writeCellValue(filepath, "Cases", 37, 8, Cataporte);
	        	
	    String NroServicio = readFile.getCellValue(filepath, "Cases", 37, 8);
        ...
        ConfirmarAvanceEstadoDespachado.click();     Thread.sleep(secDelay);
	        ...
	        String MensajeInformativoDespachado =  MensajeDespachado;
	        	writeFile.writeCellValue(filepath, "Cases", 37, 10, MensajeInformativoDespachado);
        ...
        WebElement MensajeConfirmacionRecibido = driver.findElement(By.id("messagebox-1001-msg"));
            ...
            String MensajeInformativoRecibido =  MensajeRecibido;
            	writeFile.writeCellValue(filepath, "Cases", 37, 11, MensajeInformativoRecibido);
    	    ...
    	    WebElement BotonAvanceAlternoEstadoFaltante = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("avanzarAlterno-btnWrap")));
    	     ...
    	     WebElement SelectFaltante = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[text()='Confirmado Ajuste Faltante']")));
    	        ...
    	        String MensajeInformativoEstadoFaltante =  MensajeFaltante;
            		writeFile.writeCellValue(filepath, "Cases", 37, 14, MensajeInformativoEstadoFaltante);	Thread.sleep(secDelay);
