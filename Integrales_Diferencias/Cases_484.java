...
public class Cases_484 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Faltante - Cheque mismo Banco - CDA / AG ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 40, 1);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 40, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 40, 5);
		...
		// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	 	...
	 	String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 484";
        ...
        String mensajeInformativo = Texto;
        	writeFile.writeCellValue(filepath, "Cases", 40, 7, mensajeInformativo);	
        	    	    	 	
        	    	    	
        //Mensaje Cataporte Remesa	
        	    	 	 	
        String NroObservacion =  Observacion;
        	writeFile.writeCellValue(filepath, "Cases", 40, 8, NroObservacion);
        ...
        String MensajeInformativoAprobado =  MensajeAprobado;
        	writeFile.writeCellValue(filepath, "Cases", 40, 9, MensajeInformativoAprobado);        	Thread.sleep(secDelay); 
        ...
        String Cataporte =  NumeroTexto;
            writeFile.writeCellValue(filepath, "Cases", 40, 8, Cataporte);
            	    	        	
        String NroServicio = readFile.getCellValue(filepath, "Cases", 40, 8);
        ...
        String MensajeInformativoDespachado =  MensajeDespachado;
        	writeFile.writeCellValue(filepath, "Cases", 40, 10, MensajeInformativoDespachado);
        ...
        String MensajeInformativoRecibido =  MensajeRecibido;
        	writeFile.writeCellValue(filepath, "Cases", 40, 11, MensajeInformativoRecibido);
        ...
        String MensajeInformativoEstadoFaltante =  MensajeFaltante;
        	writeFile.writeCellValue(filepath, "Cases", 40, 14, MensajeInformativoEstadoFaltante);	Thread.sleep(secDelay);
