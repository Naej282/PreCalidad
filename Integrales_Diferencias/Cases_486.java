...
public class Cases_486 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante - Abono en Cuenta - CDA / AG ----------	
		...
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 42, 5);
	    ...
	    // Cambio de Pestaña - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	 	...
	 	String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 486";
        ...
        String mensajeInformativo = Texto;
        	writeFile.writeCellValue(filepath, "Cases", 42, 7, mensajeInformativo);	
        	    	    	 	
        	    	    	
        //Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -	
        	    	 	 	
        String NroObservacion =  Observacion;
        	writeFile.writeCellValue(filepath, "Cases", 42, 8, NroObservacion);
        ...
        String MensajeInformativoAprobado =  MensajeAprobado;
        	writeFile.writeCellValue(filepath, "Cases", 42, 9, MensajeInformativoAprobado);        	Thread.sleep(secDelay); 
        ...
        String Cataporte =  NumeroTexto;
        	writeFile.writeCellValue(filepath, "Cases", 42, 8, Cataporte);
                    	    	        	
        String NroServicio = readFile.getCellValue(filepath, "Cases", 42, 8);
        ...
        String MensajeInformativoDespachado =  MensajeDespachado;
            writeFile.writeCellValue(filepath, "Cases", 42, 10, MensajeInformativoDespachado);
        ...
        String MensajeInformativoRecibido =  MensajeRecibido;
        	writeFile.writeCellValue(filepath, "Cases", 42, 11, MensajeInformativoRecibido);
        ...
        String MensajeInformativoEstadoSobrante =  MensajeSobrante;
        	writeFile.writeCellValue(filepath, "Cases", 42, 14, MensajeInformativoEstadoSobrante);	Thread.sleep(secDelay);
