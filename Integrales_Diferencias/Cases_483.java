...
public class Cases_483 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Faltante - Reposicion de Efectivo - CDA / AG ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 39, 1);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 39, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 39, 5);
		...
		// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	 	...
	 	String Modalidad ="//li[text()='Reposicion de Efectivo']";
	 	...
	 	String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 483";
        ...
        String mensajeInformativo = Texto;
        	writeFile.writeCellValue(filepath, "Cases", 39, 7, mensajeInformativo);	
        	    	    	 	
        	    	    	
        //Mensaje Cataporte Remesa	
        	    	 	 	
        String NroObservacion =  Observacion;
        	writeFile.writeCellValue(filepath, "Cases", 39, 8, NroObservacion);
        ...
        String MensajeInformativoAprobado =  MensajeAprobado;
        	writeFile.writeCellValue(filepath, "Cases", 39, 9, MensajeInformativoAprobado);        	Thread.sleep(secDelay); 
        ...
        String Cataporte =  NumeroTexto;
        	writeFile.writeCellValue(filepath, "Cases", 39, 8, Cataporte);
        	    	        	
        String NroServicio = readFile.getCellValue(filepath, "Cases", 39, 8);
    	...
    	String MensajeInformativoDespachado =  MensajeDespachado;
    		writeFile.writeCellValue(filepath, "Cases", 39, 10, MensajeInformativoDespachado);
        ...
        String MensajeInformativoRecibido =  MensajeRecibido;
        	writeFile.writeCellValue(filepath, "Cases", 39, 11, MensajeInformativoRecibido);
