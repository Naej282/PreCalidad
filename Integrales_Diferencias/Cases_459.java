...
public class Cases_459 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Faltante - Contra Gasto - AG / CDA ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 15, 3);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 15, 4);
        ...
        // Captura - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	 	...
	 	String directorioCapturas = "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 459";
	    ...
	    WebElement Envio = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("Envios")));
	    Envio.click();  
        ...
        String mensajeInformativo = texto;
    	 	writeFile.writeCellValue(filepath, "Cases", 15, 7, mensajeInformativo);	
    	 	
        
     	//Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -	 
    	 	
       	String Cataporte =  numeroTexto;
       		writeFile.writeCellValue(filepath, "Cases", 15, 8, Cataporte);
        ...
        String nroServicio = readFile.getCellValue(filepath, "Cases", 15, 8);
        ...
        String MensajeInformativoAprobado =  MensajeAprobado;
        	writeFile.writeCellValue(filepath, "Cases", 15, 9, MensajeInformativoAprobado);
        ...
        String MensajeInformativoDespachado =  MensajeDespachado;
        	writeFile.writeCellValue(filepath, "Cases", 15, 10, MensajeInformativoDespachado);
        ...
        String MensajeInformativoRecibido =  MensajeRecibido;
        	writeFile.writeCellValue(filepath, "Cases", 15, 11, MensajeInformativoRecibido);
        ...
        String MensajeInformativoFaltante =  MensajeFaltante;
        	writeFile.writeCellValue(filepath, "Cases", 15, 14, MensajeInformativoFaltante);
	    ...
	    SeleccionarTipoUnidadDiferencia.click();	 Thread.sleep(secDelay);
