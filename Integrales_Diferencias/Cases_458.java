...
public class Cases_458 {
	...
	public void test() throws IOException, InterruptedException {
			...
			//  ----------  Saldar Diferencia Faltante - Cargo de Cuenta - AG / CDA ----------	
			...
			String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 14, 5);
	        ...
	        System.out.println(DiaActualString);
		 	...
		 	String directorioCapturas = "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 458";
	        ...
	        String mensajeInformativo = texto;
	    	 	writeFile.writeCellValue(filepath, "Cases", 14, 7, mensajeInformativo);	
	    	 	
	        
	     	// Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	    	 	
	       	String Cataporte =  numeroTexto;
	       		writeFile.writeCellValue(filepath, "Cases", 14, 8, Cataporte);
	        ...
	        String nroServicio = readFile.getCellValue(filepath, "Cases", 14, 8);
	        ...
	        String MensajeInformativoAprobado =  MensajeAprobado;
	        	writeFile.writeCellValue(filepath, "Cases", 14, 9, MensajeInformativoAprobado);
	        ...
	        String MensajeInformativoDespachado =  MensajeDespachado;
	        	writeFile.writeCellValue(filepath, "Cases", 14, 10, MensajeInformativoDespachado);
            ...
            String MensajeInformativoRecibido =  MensajeRecibido;
            	writeFile.writeCellValue(filepath, "Cases", 14, 11, MensajeInformativoRecibido);
            ...
            String MensajeInformativoFaltante =  MensajeFaltante;
            	writeFile.writeCellValue(filepath, "Cases", 14, 14, MensajeInformativoFaltante);
	        ...
	        // Cargo de Cuenta, Contra Gasto y Contra Castigo - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
