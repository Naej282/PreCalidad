...
public class Cases_499 {
	...
	public void test() throws IOException, InterruptedException {
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 54, 1);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 54, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 54, 5);
		...
		String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 499";
