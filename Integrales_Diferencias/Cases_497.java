...
public class Cases_497 {
	...
	public void test() throws IOException, InterruptedException {
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 53, 1);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 53, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 53, 5);
		...
		String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 497";
