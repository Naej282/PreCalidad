...
public class Cases_480 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Faltante - Cargo de Cuenta - CDA / AG ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 36, 1);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 36, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 36, 5);
		...
		String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 480";
		...
		Envios.click();  
		 ...
		 CrearEnvio.click();
	        ...
	        String mensajeInformativo = Texto;
	    	 	writeFile.writeCellValue(filepath, "Cases", 36, 7, mensajeInformativo);	
	    	 	
	    	
	    	//Mensaje Cataporte Remesa	
     	 	
	     	String NroObservacion =  Observacion;
	        	writeFile.writeCellValue(filepath, "Cases", 36, 8, NroObservacion);
	        ...
	        String MensajeInformativoAprobado =  MensajeAprobado;
	        	writeFile.writeCellValue(filepath, "Cases", 36, 9, MensajeInformativoAprobado);        	Thread.sleep(secDelay); 
	        ...
	        // Mensaje Cataporte Remesa	- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	     	...
	     	String Cataporte =  NumeroTexto;
	        	writeFile.writeCellValue(filepath, "Cases", 36, 8, Cataporte);
	        	
	        String NroServicio = readFile.getCellValue(filepath, "Cases", 36, 8);
	        ...
	        String MensajeInformativoDespachado =  MensajeDespachado;
	        	writeFile.writeCellValue(filepath, "Cases", 36, 10, MensajeInformativoDespachado);
            ...
            String MensajeInformativoRecibido =  MensajeRecibido;
            	writeFile.writeCellValue(filepath, "Cases", 36, 11, MensajeInformativoRecibido);
	        ...
	        String MensajeInformativoEstadoFaltante =  MensajeFaltante;
        		writeFile.writeCellValue(filepath, "Cases", 36, 14, MensajeInformativoEstadoFaltante);	Thread.sleep(secDelay);
