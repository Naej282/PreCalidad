...
public class Cases_461 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Faltante - Reposición de Efectivo - AG / CDA ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 17, 3);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 17, 4);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 17, 5);
		...
		String directorioCapturas = "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 461";
	    ...
	    String mensajeInformativo = texto;
	    	 writeFile.writeCellValue(filepath, "Cases", 17, 7, mensajeInformativo);	
	    	 	
	        
	    //Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -	
	    	 	
	       	String Cataporte =  numeroTexto;
	       		writeFile.writeCellValue(filepath, "Cases", 17, 8, Cataporte);
	    ...
	    String nroServicio = readFile.getCellValue(filepath, "Cases", 17, 8);
	    ...
	    String MensajeInformativoAprobado =  MensajeAprobado;
	        writeFile.writeCellValue(filepath, "Cases", 17, 9, MensajeInformativoAprobado);
	    ...
	    String MensajeInformativoDespachado =  MensajeDespachado;
	    	writeFile.writeCellValue(filepath, "Cases", 17, 10, MensajeInformativoDespachado);
        ...
        String MensajeInformativoRecibido =  MensajeRecibido;
        	writeFile.writeCellValue(filepath, "Cases", 17, 11, MensajeInformativoRecibido);
        ...
        String MensajeInformativoFaltante =  MensajeFaltante;
        	writeFile.writeCellValue(filepath, "Cases", 17, 14, MensajeInformativoFaltante);
