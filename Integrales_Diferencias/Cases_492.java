...
public class Cases_492 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Faltante - Contra Gasto - Inventario ----------	
			...
			String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 48, 1);
			String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 48, 2);
			String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 48, 5);
		 ...
		 // Cambio de Pestaña - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
			...
			// Obtener Fecha Actual - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
				...
				String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 492";
