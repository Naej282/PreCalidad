...
public class Cases_468 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante - Cheque de otros Bancos - AG / CDA ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 24, 3);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 24, 4);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 24, 5);
		...
		String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 468";
	    ...
	    WebElement cAceptarCreacionRemesa = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("button-1133-btnWrap")));
	  	...
	  	String mensajeInformativo = texto;
	  	    writeFile.writeCellValue(filepath, "Cases", 24, 7, mensajeInformativo);	
	  	    	    	 	
	  	    	        
	  	//Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	  	    	    	 	
	  	String Cataporte =  numeroTexto;
	  		writeFile.writeCellValue(filepath, "Cases", 24, 8, Cataporte);
		...
		String nroServicio = readFile.getCellValue(filepath, "Cases", 24, 8);
		...
		String MensajeInformativoAprobado =  MensajeAprobado;
			writeFile.writeCellValue(filepath, "Cases", 24, 9, MensajeInformativoAprobado);
		...
		String MensajeInformativoDespachado =  MensajeDespachado;
			writeFile.writeCellValue(filepath, "Cases", 24, 10, MensajeInformativoDespachado);
		...
		String MensajeInformativoRecibido =  MensajeRecibido;
			writeFile.writeCellValue(filepath, "Cases", 24, 11, MensajeInformativoRecibido);
		...
		String MensajeInformativoSobrante =  MensajeSobrante;
			writeFile.writeCellValue(filepath, "Cases", 24, 16, MensajeInformativoSobrante);
