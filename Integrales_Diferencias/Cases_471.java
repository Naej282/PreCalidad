...
public class Cases_471 {
	...
	public void test() throws IOException, InterruptedException {
		...
		String TipoUnidad = readFile.getCellValue(filepath, "Cases", 27, 1);
		String Unidad = readFile.getCellValue(filepath, "Cases", 27, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 27, 5);
		...
		String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 471";
