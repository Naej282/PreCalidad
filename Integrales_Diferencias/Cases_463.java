...
public class Cases_463 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Faltante - Cheque de otros Bancos - AG / CDA ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 19, 3);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 19, 4);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 19, 5);
		...
		String directorioCapturas = "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 463";
	    ...
	    String mensajeInformativo = texto;
	    	 writeFile.writeCellValue(filepath, "Cases", 19, 7, mensajeInformativo);	
	    	 	
	        
	    //Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	    	 	
	    String Cataporte =  numeroTexto;
	       	writeFile.writeCellValue(filepath, "Cases", 19, 8, Cataporte);
		...
		String nroServicio = readFile.getCellValue(filepath, "Cases", 19, 8);
	    ...
	    String MensajeInformativoAprobado =  MensajeAprobado;
	        writeFile.writeCellValue(filepath, "Cases", 19, 9, MensajeInformativoAprobado);
	    ...
	    String MensajeInformativoDespachado =  MensajeDespachado;
	        writeFile.writeCellValue(filepath, "Cases", 19, 10, MensajeInformativoDespachado);
        ...
        WebElement InformacionAvanceRecibido = driver.findElement(By.id("messagebox-1027-msg"));
         ...
         String MensajeInformativoRecibido =  MensajeRecibido;
             writeFile.writeCellValue(filepath, "Cases", 19, 11, MensajeInformativoRecibido);
         ...
         String MensajeInformativoFaltante =  MensajeFaltante;
            writeFile.writeCellValue(filepath, "Cases", 19, 14, MensajeInformativoFaltante);
