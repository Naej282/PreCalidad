...
public class Cases_470 {
	...
	public void test() throws IOException, InterruptedException {
		...
		String TipoUnidad = readFile.getCellValue(filepath, "Cases", 26, 1);
		String Unidad = readFile.getCellValue(filepath, "Cases", 26, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 26, 5);
		...
		String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 470";
