...
public class Cases_493 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Faltante - Contra Castigo - Inventario ----------	
				...
				String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 49, 1);
				String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 49, 2);
				String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 49, 5);
			...
			// Obtener Fecha Actual - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
				...
				String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 493";
