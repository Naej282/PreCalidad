...
public class Cases_465 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante - Contra Ingreso - AG / CDA ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 21, 3);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 21, 4);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 21, 5);
		...
		String directorioCapturas = "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 465";
	    ...
	    String mensajeInformativo = texto;
	    	 writeFile.writeCellValue(filepath, "Cases", 21, 7, mensajeInformativo);	
	    	 	
	        
	    // Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	    	 	
	    String Cataporte =  numeroTexto;
	       	writeFile.writeCellValue(filepath, "Cases", 21, 8, Cataporte);
		...
		String nroServicio = readFile.getCellValue(filepath, "Cases", 21, 8);
		...
		String MensajeInformativoAprobado =  MensajeAprobado;
			writeFile.writeCellValue(filepath, "Cases", 21, 9, MensajeInformativoAprobado);
		...
		String MensajeInformativoDespachado =  MensajeDespachado;
			writeFile.writeCellValue(filepath, "Cases", 21, 10, MensajeInformativoDespachado);
		...
		String MensajeInformativoRecibido =  MensajeRecibido;
			writeFile.writeCellValue(filepath, "Cases", 21, 11, MensajeInformativoRecibido);
	    ...
	    String MensajeInformativoSobrante =  MensajeSobrante;
	        writeFile.writeCellValue(filepath, "Cases", 21, 16, MensajeInformativoSobrante);
