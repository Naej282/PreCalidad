...
public class Cases_480_485 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Faltante - CDA / AG ----------	
		...
		String outputFile = ""+Constantes.RUTA_CAPTURES+"\\Integrales_Diferencia\\Cases_480_485\\"+nombreArchivo+"";
		...
		String directorioCapturas =  "" + Constantes.RUTA_CAPTURES + "\\Integrales_Diferencia\\Cases_480_485";
        ...
        WebElement CampoCodigoRemesa1 = driver.findElement(By.id("gridcolumn-1065-triggerEl"));     
        actions.moveToElement(CampoCodigoRemesa).moveToElement(CampoCodigoRemesa1).perform();  
