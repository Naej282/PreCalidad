...
public class Cases_487 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante - Contra Ingreso - CDA / AG ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 43, 1);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 43, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 43, 5);
		...
		// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	 	...
	 	String Modalidad ="//li[text()='Contra Ingreso']";
	 	...
	 	String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 487";
        ...
        String mensajeInformativo = Texto;
        	writeFile.writeCellValue(filepath, "Cases", 43, 7, mensajeInformativo);	
        	    	    	 	
        	    	    	
        //Mensaje Cataporte Remesa	
        	    	 	 	
        String NroObservacion =  Observacion;
        	writeFile.writeCellValue(filepath, "Cases", 43, 8, NroObservacion);
            ...
            String MensajeInformativoAprobado =  MensajeAprobado;
            	writeFile.writeCellValue(filepath, "Cases", 43, 9, MensajeInformativoAprobado);        	Thread.sleep(secDelay); 
         ...
         String Cataporte =  NumeroTexto;
         	writeFile.writeCellValue(filepath, "Cases", 43, 8, Cataporte);
                     	    	        	
         String NroServicio = readFile.getCellValue(filepath, "Cases", 43, 8);
         ...
         String MensajeInformativoDespachado =  MensajeDespachado;
             writeFile.writeCellValue(filepath, "Cases", 43, 10, MensajeInformativoDespachado);
        ...
        WebElement MensajeConfirmacionRecibido = driver.findElement(By.id("messagebox-1001-msg"));
         ...
         String MensajeInformativoRecibido =  MensajeRecibido;
         	writeFile.writeCellValue(filepath, "Cases", 43, 11, MensajeInformativoRecibido);
            ...
            String MensajeInformativoEstadoSobrante =  MensajeSobrante;
            	writeFile.writeCellValue(filepath, "Cases", 43, 14, MensajeInformativoEstadoSobrante);	Thread.sleep(secDelay);
