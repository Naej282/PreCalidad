...
public class Cases_489 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante - Cheque mismo Banco - CDA / AG ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 45, 1);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 45, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 45, 5);
		...
		// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	 	...
	 	String Modalidad ="//li[text()='Cheque mismo Banco']";
	 	...
	 	String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 489";
	    ...
	    String mensajeInformativo = Texto;
	    	writeFile.writeCellValue(filepath, "Cases", 45, 7, mensajeInformativo);	
	            	    	    	 	
	            	    	    	
	    //Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -	
	            	    	 	 	
	    String NroObservacion =  Observacion;
	    	writeFile.writeCellValue(filepath, "Cases", 45, 8, NroObservacion);
	    ...
	    String MensajeInformativoAprobado =  MensajeAprobado;
	    	writeFile.writeCellValue(filepath, "Cases", 45, 9, MensajeInformativoAprobado);        	Thread.sleep(secDelay); 
	    ...
	    String Cataporte =  NumeroTexto;
	    	writeFile.writeCellValue(filepath, "Cases", 45, 8, Cataporte);
	                     	    	        	
	    String NroServicio = readFile.getCellValue(filepath, "Cases", 45, 8);
	    ...
	    String MensajeInformativoDespachado =  MensajeDespachado;
	    	writeFile.writeCellValue(filepath, "Cases", 45, 10, MensajeInformativoDespachado);
	    ...
	    String MensajeInformativoRecibido =  MensajeRecibido;
	    	writeFile.writeCellValue(filepath, "Cases", 45, 11, MensajeInformativoRecibido);
	    ...
	    String MensajeInformativoEstadoSobrante =  MensajeSobrante;
	    	writeFile.writeCellValue(filepath, "Cases", 45, 14, MensajeInformativoEstadoSobrante);	Thread.sleep(secDelay); 
