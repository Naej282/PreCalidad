...
public class Cases_460 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Faltante - Contra Castigo - AG / CDA ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 16, 3);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 16, 4);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 16, 5);
		...
		// Captura - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	 	...
	 	String directorioCapturas = "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 460";
		...
		cElementoDolar.click();
	     ...
	     String mensajeInformativo = texto;
	    	 writeFile.writeCellValue(filepath, "Cases", 16, 7, mensajeInformativo);	
	    	 	
	        
	     //Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -	
	    	 	
	     String Cataporte =  numeroTexto;
	       	writeFile.writeCellValue(filepath, "Cases", 16, 8, Cataporte);
	     ...
	     String nroServicio = readFile.getCellValue(filepath, "Cases", 16, 8);
	     ...
	     String MensajeInformativoAprobado =  MensajeAprobado;
	        writeFile.writeCellValue(filepath, "Cases", 16, 9, MensajeInformativoAprobado);
	     ...
	     String MensajeInformativoDespachado =  MensajeDespachado;
	     	writeFile.writeCellValue(filepath, "Cases", 16, 10, MensajeInformativoDespachado);
         ...
         String MensajeInformativoRecibido =  MensajeRecibido;
         	writeFile.writeCellValue(filepath, "Cases", 16, 11, MensajeInformativoRecibido);
         ...
         String MensajeInformativoFaltante =  MensajeFaltante;
            writeFile.writeCellValue(filepath, "Cases", 16, 14, MensajeInformativoFaltante);
