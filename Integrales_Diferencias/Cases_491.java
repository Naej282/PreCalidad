...
public class Cases_491 {
	...
	public void test() throws IOException, InterruptedException {
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 47, 1);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 47, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 47, 5);
		...
		// Obtener Fecha Actual - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
			...
			String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 491";
