...
public class Cases_469 {
	...
	public void test() throws IOException, InterruptedException {
		...
		String TipoUnidad = readFile.getCellValue(filepath, "Cases", 25, 1);
		String Unidad = readFile.getCellValue(filepath, "Cases", 25, 2);
		...
		String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 469";
	    ...
	    // Pestaña Inventario - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	        ...
	        DesplegarUnidadInventario.click(); 	   Thread.sleep(secDelay);
	  	    ...
	  	    WebElement SeleccionarDivisaInventario = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[@class='x-boundlist-item'][text()='Dólar']")));
