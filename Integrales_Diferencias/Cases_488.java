...
public class Cases_488 {
	...
	public void test() throws IOException, InterruptedException {
		...
		//  ----------  Saldar Diferencia Sobrante - Entrega de Efectivo - CDA / AG ----------	
		...
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 44, 1);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 44, 2);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 44, 5);
		...
		// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	 	...
	 	String directorioCapturas =  "" + Constante_PreCalidad.RUTA_CAPTURES + "\\Cases 488";
        ...
        String mensajeInformativo = Texto;
        	writeFile.writeCellValue(filepath, "Cases", 44, 7, mensajeInformativo);	
        	    	    	 	
        	    	    	
        //Mensaje Cataporte Remesa - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -	
        	    	 	 	
        String NroObservacion =  Observacion;
        	writeFile.writeCellValue(filepath, "Cases", 44, 8, NroObservacion);
        ...
        String MensajeInformativoAprobado =  MensajeAprobado;
        	writeFile.writeCellValue(filepath, "Cases", 44, 9, MensajeInformativoAprobado);        	Thread.sleep(secDelay); 
     ...
     String Cataporte =  NumeroTexto;
     	writeFile.writeCellValue(filepath, "Cases", 44, 8, Cataporte);
                 	    	        	
     String NroServicio = readFile.getCellValue(filepath, "Cases", 44, 8);
     ...
     String MensajeInformativoDespachado =  MensajeDespachado;
         writeFile.writeCellValue(filepath, "Cases", 44, 10, MensajeInformativoDespachado);
        ...
        WebElement MensajeConfirmacionRecibido = driver.findElement(By.id("messagebox-1001-msg"));
         ...
         String MensajeInformativoRecibido =  MensajeRecibido;
         	writeFile.writeCellValue(filepath, "Cases", 44, 11, MensajeInformativoRecibido);
            ...
            String MensajeInformativoEstadoSobrante =  MensajeSobrante;
            	writeFile.writeCellValue(filepath, "Cases", 44, 14, MensajeInformativoEstadoSobrante);	Thread.sleep(secDelay);
        ...
        // Entrega de Efectivo - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -   
                ...
                WebElement SeleccionarDenominación = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[text()='Billete - 100,000']")));
