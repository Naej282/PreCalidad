...
public class Cases_222_224_226 {
	...
	public void test() throws InterruptedException, IOException {
	    ...
	    String outputFile = "C:\\Users\\esalvatierra\\Videos\\EvidenciasCOE\\PreCalidad\\NoCriticosAgencia\\Case_222_224_226\\"+nombreArchivo+"";
	...
	WebDriverWait ewait = new WebDriverWait(driver,10); //Espera Explícita
    ...
    String captura1 = directorioCapturas + "/" + nombreArchivo2;
	    ...
	    FileUtils.copyFile(archivo, new File(captura));		Thread.sleep(secDelay);Thread.sleep(secDelay);
