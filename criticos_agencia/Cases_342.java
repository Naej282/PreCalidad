...
//		--------------------------------------Reverso de Remesas en Agencia Emisor (estado Devuelto) / Control de Remesas / Envíos-------------------------------
		...
		String outputFile = ""+Constantes.RUTA_CAPTURES+"\\Criticos_Agencia\\Cases_342\\342.avi";
		...
		String TipoUnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 33, 1);
		String	UnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 33, 2);
		String	Transporte = readFile.getCellValue(filepath, "CriticosAgencia", 33, 5);
		...
		WebElement AvanceEstadoAlterno = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("avanzarAlterno-btnInnerEl")));
		AvanceEstadoAlterno.click();	 Thread.sleep(secDelay);	
		WebElement DesplegarAvanzarAlEstado = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("nodoAlterno-trigger-picker")));
		DesplegarAvanzarAlEstado.click();	  Thread.sleep(secDelay);	
		WebElement AvanzarAlEstado = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[text()='Devuelto']")));
		AvanzarAlEstado.click();	 Thread.sleep(secDelay);	
		WebElement AceptarAvance = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("aceptarAvanzarAlterno-btnInnerEl")));
		AceptarAvance.click();	   Thread.sleep(secDelay);
		...
		WebElement AceptarInformacion = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("button-1031-btnInnerEl")));
		...
		WebElement Filtrar2 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("filtrosEnvio-btnEl")));
		Filtrar2.click();	  Thread.sleep(secDelay);	
		WebElement AceptarFiltrar = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("button-1174-btnInnerEl")));
		AceptarFiltrar.click();		Thread.sleep(secDelay);
