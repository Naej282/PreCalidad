...
//		------------------------Reverso de Remesas en Agencia Emisor (estado Despachado) / Control de Remesas / Envíos---------------------------
		...
		String outputFile = ""+Constantes.RUTA_CAPTURES+"\\Criticos_Agencia\\Cases_339\\339.avi";
		...
		String TipoUnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 32, 1);
		String	UnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 32, 2);
		String	Transporte = readFile.getCellValue(filepath, "CriticosAgencia", 32, 5);
		...
		WebElement AceptarInfo = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("button-1006-btnInnerEl")));
		AceptarInfo.click();
        ...
        String ExpectativaTexto07 = "No se puede reversar a ese estado desde esta Aplicación";
