...
//		--------------------- Reverso de Remesas en Agencia Receptor (estado Confirmado Ajuste Detalle) / Control de Remesas / Envíos-------------------
		...
		String outputFile = ""+Constantes.RUTA_CAPTURES+"\\Criticos_Agencia\\Cases_337\\337.avi";
		...
		String TipoUnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 31, 1);
		String	UnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 31, 2);
		String	Transporte = readFile.getCellValue(filepath, "CriticosAgencia", 31, 5);
		...
		WebElement EstadoAlterno = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[text()='Confirmado Ajuste Sobrante']")));
		EstadoAlterno.click();	
		...
		WebElement Denominacion = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[text()='"+Constantes.DENOMINACION_DIFERENCIA2+"']")));
		Denominacion.click();		
