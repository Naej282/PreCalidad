...
//		-------------------------------Reverso de Remesas en Agencia Receptor (estado Devuelto) / Control de Remesas / Envíos---------------------------------
		
		//RUTA PARA GRABAR LA PANTALLA--------------------------------------------------------------------
		
		String outputFile = ""+Constantes.RUTA_CAPTURES+"\\Criticos_Agencia\\Cases_318\\318.avi";
		...
		String TipoUnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 26, 1);
		String	UnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 26, 2);
		String	Transporte = readFile.getCellValue(filepath, "CriticosAgencia", 26, 5);
		...
		WebElement EstadoAlterno = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[text()='Devuelto']")));
		EstadoAlterno.click();		
