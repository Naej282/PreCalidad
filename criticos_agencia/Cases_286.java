...
public class Cases_286 {
	...
	public void test() throws InterruptedException, IOException {
		...
		//------------------------- Reverso de Remesas en Agencia (estado Aprobado) / Control de Remesas / Envíos---------------------------
		
		WebDriverWait ewait = new WebDriverWait(driver,20); //Espera Explícita
		
		//RUTA PARA GRABAR LA PANTALLA--------------------------------------------------------------------
		
		String outputFile = ""+Constantes.RUTA_CAPTURES+"\\Criticos_Agencia\\Cases_286\\286.avi";
		...
		String TipoUnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 23, 1);
		String	UnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 23, 2);
		String	Transporte = readFile.getCellValue(filepath, "CriticosAgencia", 23, 5);
		...
		WebElement SeleccionRemesa = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("gridview-1095-record-120")));
		SeleccionRemesa.click();	
		WebElement SeleccionarRemesa2 = driver.findElement(By.id("gridview-1095-record-120")); 
		...
		WebElement Reversar2 = driver.findElement(By.id("reversar-btnWrap"));
		Reversar2.click();		Thread.sleep(secDelay);	
		WebElement AceptarReverso = driver.findElement(By.id("aceptarReversar-btnEl"));
		AceptarReverso.click();		Thread.sleep(secDelay);
        ...
        String ExpectativaTexto3 = "No se puede reversar a ese estado desde esta Aplicación";
        Assert.assertEquals(ObtenerMensaje3, ExpectativaTexto3);
		
		WebElement AceptarAdvertencia = driver.findElement(By.id("button-1005-btnInnerEl"));
