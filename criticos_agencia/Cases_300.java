...
public class Cases_300 {
	...
	public void test() throws InterruptedException, IOException {
		...
		//---------------------------Reverso de Remesas en Agencia Receptor (estado Despachado) / Control de Remesas / Envíos--------------------
		
		WebDriverWait ewait = new WebDriverWait(driver,20); //Espera Explícita
		
		//RUTA PARA GRABAR LA PANTALLA--------------------------------------------------------------------
		
		String outputFile = ""+Constantes.RUTA_CAPTURES+"\\Criticos_Agencia\\Cases_300\\300.avi";
		...
		String TipoUnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 24, 1);
		String	UnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 24, 2);
		String	Transporte = readFile.getCellValue(filepath, "CriticosAgencia", 24, 5);
...
//		INGRESAMOS EN EL APARTADO DE ENVIOS------------------------------------------------------------------------------------------------------
		...
		WebElement AceptarConfirmacion2 = driver.findElement(By.id("button-1006-btnEl"));
		AceptarConfirmacion2.click();		Thread.sleep(secDelay);	
        ...
        String ExpectativaTexto4 = "No se puede reversar a ese estado desde esta Aplicación";
        Assert.assertEquals(ObtenerMensaje4, ExpectativaTexto4);
				
		WebElement AceptarAdvertencia = driver.findElement(By.id("button-1005-btnEl"));
