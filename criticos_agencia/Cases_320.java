...
//		-------------------------------Reverso de Remesas en Agencia Receptor (estado Recibido) / Control de Remesas / Envíos----------------------------
		...
		String outputFile = ""+Constantes.RUTA_CAPTURES+"\\Criticos_Agencia\\Cases_320\\320.avi";
		...
		String TipoUnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 27, 1);
		String	UnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 27, 2);
		String	Transporte = readFile.getCellValue(filepath, "CriticosAgencia", 27, 5);
