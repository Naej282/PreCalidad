...
//		----------------------------------------------Inventario - Ajustar Bóveda (Sobrante) / Módulo Agencia------------------------------------------
		
	    //RUTA PARA GRABAR LA PANTALLA--------------------------------------------------------------------
	
		String outputFile = ""+Constantes.RUTA_CAPTURES+"\\Criticos_Agencia\\Cases_191\\191.avi";
        ...
        //TOMA DE EVIDENCIAS--------------------------------------------------------------------------------------------------
		String directorioCapturas = ""+Constantes.RUTA_CAPTURES+"\\Criticos_Agencia\\Cases_191";
