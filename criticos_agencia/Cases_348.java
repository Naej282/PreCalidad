...
//		----------------------------Reverso de Remesas en Agencia Emisor (estado Confirmado Ajuste Faltante) / Control de Remesas / Envíos----------------------
		...
		String outputFile = ""+Constantes.RUTA_CAPTURES+"\\Criticos_Agencia\\Cases_348\\348.avi";
		...
		String TipoUnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 36, 1);
		String	UnidadEmisora = readFile.getCellValue(filepath, "CriticosAgencia", 36, 2);
		String	Transporte = readFile.getCellValue(filepath, "CriticosAgencia", 36, 5);
