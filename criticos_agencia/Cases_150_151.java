...
//		---------------------------------------------- Consulta de Inventario / Módulo Agencia---------------------------------------------------------
		
		//RUTA PARA GRABAR LA PANTALLA--------------------------------------------------------------------
		
		String outputFile = ""+Constantes.RUTA_CAPTURES+"\\Criticos_Agencia\\Cases_150_151\\150_151.avi";
		...
		TipoDeBoveda.click();	  Thread.sleep(secDelay);
		...
		//IMPRIMIMOS EL INVENTARIO (CASES 151)----------------------------- Imprimir Inventario / Módulo Agencia------------------------------------------------
		...
		Formato.click();
		WebElement Consultar2 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("button-1118-btnInnerEl")));
		Consultar2.click();
		...
		Formato2.click();
		WebElement Consultar3 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("button-1118-btnInnerEl")));
		Consultar3.click();
	}
