...
public class Cases_370 {
	...
	public void test() throws IOException, InterruptedException {
		...
		// ---------- Ajuste de Inventario Sobrante y Faltante ----------
		...
		String directorioCapturas = "C:/Users/gsarmiento/Desktop/Cases Integrales - Automatización/Cases 370";
	    ...
	    WebElement desplegarDenominaciónSobrante = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("denominacionSobrantesAjuste-trigger-picker")));
	    desplegarDenominaciónSobrante.click();
	    Thread.sleep(secDelay);
	    WebElement seleccionarDenominaciónSobrante = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"boundlist-1111-listEl\"]/li[14]")));
	    seleccionarDenominaciónSobrante.click();
	    WebElement desplegarClasificacionSobrante = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("clasificacionSobrantesAjuste-trigger-picker")));
	    desplegarClasificacionSobrante.click();
	    WebElement seleccionarClasificaciónSobrante = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"boundlist-1113-listEl\"]/li[1]")));
	    seleccionarClasificaciónSobrante.click();
	    WebElement colocarCantidadSobrante = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("cantidadSobrantesAjuste-inputEl")));
	    colocarCantidadSobrante.sendKeys("1");
	    WebElement incluirSobrante = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("incluirAju2Ajuste-btnWrap")));
	    ...
	    WebElement aceptarImprimir = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("button-1119-btnWrap")));
	    ...
	    WebElement aceptarImprimir2 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("button-1119-btnWrap")));
