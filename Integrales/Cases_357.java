...
public class Cases_357 {
	...
	public void test() throws InterruptedException, IOException {
		...
		// ---------- Pase Boveda a ATM Normal ----------
		
		//guardar 
		
		String directorioCapturas = "C:\\Users\\gsarmiento\\Desktop\\Cases Integrales - Automatización\\Cases 357";
	    ...
	    WebElement DesplegarMonto = driver.findElement(By.id("gridview-1020"));
		...
		WebElement Consultar3 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("buscarFiltro-btnInnerEl")));
			...
			WebElement DesplegarMontos2 = driver.findElement(By.id("gridview-1020"));
		...
		WebElement Consultar6 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("buscarFiltro-btnInnerEl")));
			...
			WebElement DesplegarMontos3 = driver.findElement(By.id("gridview-1020"));
		...
		WebElement DesplegarMontos4 = driver.findElement(By.id("gridview-1020"));
