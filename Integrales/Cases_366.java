...
public class Cases_366 {
	...
	public void test() throws IOException, InterruptedException {
		...
		String directorioCapturas = ""+Constante_PreCalidad.RUTA_CAPTURES+"//Integrales//Cases 366";
		...
		//Bloque de codigo para generar un numero random----------------------------------------------------
		...
		String TipoUnidadEmisora = readFile.getCellValue(filepath, "Cases", 59, 1);
		String UnidadEmisora = readFile.getCellValue(filepath, "Cases", 59, 2);
		String TipoUnidadReceptora = readFile.getCellValue(filepath, "Cases", 59, 3);
		String UnidadReceptora = readFile.getCellValue(filepath, "Cases", 59, 4);
		String EmpresaTransportista = readFile.getCellValue(filepath, "Cases", 59, 5);
		String UnidadEmisoraFiltros = readFile.getCellValue(filepath, "Cases", 4, 3);
        ...
        WebElement escribirTipoUnidadEmisora = driver.findElement(escribirTipoUnidadReceptoraLocator);	Thread.sleep(secDelay);
        escribirTipoUnidadEmisora.sendKeys(TipoUnidadReceptora);
        escribirTipoUnidadEmisora.sendKeys(Keys.ENTER);
        WebElement escribirUnidadEmisora = driver.findElement(escribirUnidadEmisoraLocator);	Thread.sleep(secDelay);
        escribirUnidadEmisora.sendKeys(UnidadReceptora);
        escribirUnidadEmisora.sendKeys(Keys.ENTER);
        WebElement Transportista = driver.findElement(TransportistaLocator);	Thread.sleep(secDelay);
	 ...
	 // Visualizar el inventario emisor------------------------------------------------------------------------------------------------
        ...
        //Ingresamose en el modulo de agencia--------------------------------------------------------------------------------------------
		...
		WebElement TipoUnidad = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[text()='"+TipoUnidadEmisora+"']")));
		TipoUnidad.click();	
	    ...
	    //Visualizar el inventario receptor------------------------------------------------------------------------------------
	 ...
	 // Mantener presionada la tecla Shift y presionar la tecla flecha hacia abajo
		...
		WebElement Consultar4 = ewait.until(ExpectedConditions.visibilityOfElementLocated(By.id("buscarFiltro-btnInnerEl")));
 		Consultar4.click();		Thread.sleep(secDelay);Thread.sleep(secDelay);
		...
		driver.switchTo().window(VisualizarInventarioReceptor);
 		...
 		Consultar5.click();		Thread.sleep(secDelay);Thread.sleep(secDelay);
	    ...
	    //INVENTARIO EMISOR----------------------------------------------------------------------------------------
 		...
 		Consultar6.click();		Thread.sleep(secDelay);Thread.sleep(secDelay);
	    ...
	    //INVENTARIO EMISOR-----------------------------------------------------------------------------------------------
 		...
 		Consultar8.click();		Thread.sleep(secDelay);Thread.sleep(secDelay);
 		...
 		Consultar9.click();		Thread.sleep(secDelay);Thread.sleep(secDelay);
	 ...
	 // Mantener presionada la tecla Shift y presionar la tecla flecha hacia abajo-------------------------------------------
	    ...
	    //INVENTARIO EMISOR--------------------------------------------------------------------------------------------------
 		...
 		Consultar10.click();	 Thread.sleep(secDelay);Thread.sleep(secDelay);
